...
OLLAMA_URL="${OPENCLAW_OLLAMA_URL:-http://localhost:11434}"
MODEL_FAST="${OPENCLAW_MODEL_FAST:-qwen3.5:4b}"
MODEL_DEEP="${OPENCLAW_MODEL_DEEP:-llama3:8b}"
MODEL_EMBED="${OPENCLAW_MODEL_EMBED:-nomic-embed-text}"

echo "╔═══════════════════════════════════════════════╗"
echo "║  OpenClaw Evolution v0.2 — Démarrage          ║"
echo "╚═══════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "🚀 Lancement OpenClaw Evolution v0.2..."
echo "──────────────────────────────────────"
