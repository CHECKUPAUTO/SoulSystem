...
pub use htest::{
    chi2_gof_discrete, chi_square_gof, ks_test_one_sample, one_way_anova, t_test_one_sample,
    t_test_two_sample, Tail, TestResult,
};
pub use lottery::{draw_frequency_chi_square, LotteryGame, PrizeTier};
pub use rng::SplitMix64;
pub use robust::{
    interquartile_range, median_absolute_deviation, median_of_means, trimmed_mean, weighted_median,
    winsorized_mean, MadConsistency, MedianOfMeansConfig, MedianOfMeansPartition, RobustStatsError,
};
...
pub mod prelude {
    ...
    pub use crate::lottery::{draw_frequency_chi_square, LotteryGame, PrizeTier};
    pub use crate::rng::SplitMix64;
    pub use crate::robust::{
        interquartile_range, median_absolute_deviation, median_of_means, trimmed_mean,
        weighted_median, winsorized_mean, MadConsistency, MedianOfMeansConfig,
        MedianOfMeansPartition, RobustStatsError,
    };
}
