...
- **Issue #64695** — Formal proposal for SQLite fallback strategy landed in `eb9d8d41cc`
- Monitor for merge into main branch
- Once merged, this reference should be updated with implementation details and API surface
...
**Proposal #64695** (upstream) addresses SQLite fallback with formal proposal status.
Key points:
- WAL-mode SQLite for crash recovery
- Fallback strategy for node:sqlite failures
- This doc should be updated once #64695 lands in main

Monitor: https://github.com/openclaw/openclaw/issues/64695
