...
### Upstream Reference (2026-04-12)
- **Issue #64687** — Formal session persistence proposal landed in `eb9d8d41cc`
- Key proposals: checkpoint-on-idle pattern, WAL-mode SQLite for crash recovery, state versioning, integrity checksums
- Monitor for merge into main branch; update this reference with implementation details once available
- Cross-reference: `sqlite_fallback_strategy.md` (related #64695)
...
**Proposal #64687** (upstream) formalizes session persistence:
- Checkpoint-on-idle pattern
- State versioning for migration compatibility
- State integrity checksums for corruption detection

This reference overlaps with the upstream proposal. Update when implementation begins.

Monitor: https://github.com/openclaw/openclaw/issues/64687
