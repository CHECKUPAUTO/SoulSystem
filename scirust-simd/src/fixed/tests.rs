...
use super::conv::{conv1d, conv1d_batch, Conv1dShape};
use super::conv2d::{
    conv2d, conv2d_batch, conv2d_transpose, depthwise_conv2d, dilated_conv2d, separable_conv2d,
    Conv2dShape, Conv2dTransposeShape, DilatedConv2dShape,
};
...
use super::pool::{avg_pool1d, max_pool1d, Pool1dShape};
use super::pool2d::{avg_pool2d, max_pool2d, Pool2dShape};
...
use super::transformer::{rope_apply_heads, TransformerBlock};
use super::{
    FixedI16, FixedI32, FixedI64, NumericScalar, OverflowMode, RealScalar, RoundingMode, Q16_16,
    Q1_15, Q24_8, Q32_32, Q8_24, Q8_8,
};
...
fn eigenvectors_general_matches_eigenvalue_equation() {
    ...
    for (i, (ev, v)) in eigenvalues.iter().zip(&vectors).enumerate() {
        let linalg::Eigenvalue::Real(lambda) = *ev else {
            panic!(
