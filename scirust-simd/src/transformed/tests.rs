...
use super::branch::{GammaBranch, GAMMA_TURN_X};
use super::hypercomplex::{
    model_a_product, model_b_product, Hypercomplex, Octonion, Quaternion, Sedenion,
};
...
use super::special::{digamma, gamma, ln_gamma, GAMMA_ARGMIN};
