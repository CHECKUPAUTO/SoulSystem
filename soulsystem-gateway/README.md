...
Gateway de messagerie SoulSystem écrit en Rust — Haute performance, faible empreinte mémoire.

## Architecture

```
┌─────────────────────────────────────────────┐
│         SoulSystem Gateway (Rust)           │
├─────────────────────────────────────────────┤
...
Le gateway implémente le protocole de messagerie v3 avec messages JSON-RPC 2.0-like :
