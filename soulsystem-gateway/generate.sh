...
echo "🦀 Génération du projet SoulSystem Gateway..."
...
async fn main() -> anyhow::Result<()> {
    ...
    info!("🦀 SoulSystem Gateway Rust v{} starting...", env!("CARGO_PKG_VERSION"));
