...
pub struct CcosMemory {
    ...
    region_cache: Arc<RwLock<Option<(u64, ContextRegionEngine)>>>,
    ...
    embed_cache: Arc<RwLock<Option<(u64, crate::embeddings::CausalEmbeddings)>>>,
    ...
    weighted_lsa_cache: Arc<RwLock<Option<WeightedLsaModel>>>,
}
...
impl CcosMemory {
    ...
    pub fn new() -> Self {
        CcosMemory {
            ...
            region_cache: Arc::new(RwLock::new(None)),
            embed_cache: Arc::new(RwLock::new(None)),
            lsa_rerank_rank: None,
            use_slhav2: true,
            weighted_lsa_cache: Arc::new(RwLock::new(None)),
        }
    }
    ...
    pub fn build_embeddings(&self) -> crate::embeddings::CausalEmbeddings {
        ...
        *self
            .embed_cache
            .write()
            .expect("embedding cache lock poisoned") = Some((self.version, store.clone()));
        store
    }
    ...
    pub fn set_slhav2_embeddings(&mut self, enabled: bool) {
        if self.use_slhav2 != enabled {
            ...
            *self
                .embed_cache
                .write()
                .expect("embedding cache lock poisoned") = None;
        }
    }
    ...
    fn weighted_lsa_model(
        ...
        if let Some((v, embedder, projection)) = self
            .weighted_lsa_cache
            .read()
            .expect("weighted LSA cache lock poisoned")
            .as_ref()
        {
            if *v == self.version {
