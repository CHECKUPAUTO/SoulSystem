...
const PRIMITIVES = [
  {
    ...
    file: "crates/soulsystem_engine/src/types/thread.rs",
  },
  {
    name: "Step",
    ...
    color: COLORS.cyan,
    file: "crates/soulsystem_engine/src/types/step.rs",
  },
  {
    name: "Capability",
    ...
    color: COLORS.accent,
    file: "crates/soulsystem_engine/src/capability/",
  },
  {
    name: "MemoryDoc",
    ...
    file: "crates/soulsystem_engine/src/types/memory.rs",
  },
  {
    name: "Project",
    ...
    color: COLORS.purple,
    file: "crates/soulsystem_engine/src/types/project.rs",
  },
];
...
export const PrimitivesScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        crates/soulsystem_engine/ &mdash; replaces ~10 v1 abstractions
      </div>
