# SoulSystem Architecture Overview Video

A Remotion-based animated video that walks new contributors through SoulSystem's
...
```console
npx remotion render SoulSystemArchitecture out.mp4
```
...
- `src/SoulSystemArchitecture.tsx` — scene sequencing, durations, transitions
...
This video project is part of SoulSystem and dual-licensed MIT OR Apache-2.0.
