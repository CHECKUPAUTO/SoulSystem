...
Connect SoulSystem to Signal so you can talk to your agent in direct messages.
...
The Signal channel connects SoulSystem to a running [signal-cli](https://github.com/AsamK/signal-cli) HTTP daemon. Before configuring SoulSystem, start signal-cli in daemon mode on your machine.
