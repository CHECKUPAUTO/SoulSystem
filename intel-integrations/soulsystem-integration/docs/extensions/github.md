...
```bash
soulsystem registry install github
```
...
After installing the extension, you need to configure your Github API key in SoulSystem. You can do this by running:

```bash
soulsystem tool auth github
```
