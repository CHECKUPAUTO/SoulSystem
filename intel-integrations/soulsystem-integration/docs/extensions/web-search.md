...
```bash
soulsystem registry install web-search
```
...
After installing the extension, you need to configure your Brave Search API key in SoulSystem. You can do this by running:

```bash
soulsystem tool auth web-search
```
