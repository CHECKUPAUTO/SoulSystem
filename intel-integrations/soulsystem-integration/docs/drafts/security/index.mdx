...
description: SoulSystem's defense-in-depth security architecture
---

Security is SoulSystem's primary differentiator. Your data stays yours through multiple layers of defense.

## Security-First Design

SoulSystem is built with security as a core principle:
...
<Frame>
  <img src="/assets/security-architecture.svg" alt="SoulSystem Security Architecture Diagram" />
</Frame>
...
The security architecture illustrates SoulSystem's **defense in depth** approach with four independent protection layers that data flows through before reaching external services.
...
SoulSystem ships with secure defaults:
...
SoulSystem helps with security compliance:

| Requirement | SoulSystem Feature |
|-------------|-----------------|
...
1. Email security@soulsystem.ai
