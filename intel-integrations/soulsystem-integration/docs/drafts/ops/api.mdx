...
description: Complete endpoint reference for the SoulSystem Web Gateway API
---

The SoulSystem Web Gateway exposes a REST API for all agent operations. All endpoints require bearer token authentication.
...
For remote deployments, replace with your reverse proxy domain (e.g., `https://soulsystem.yourdomain.com`).
