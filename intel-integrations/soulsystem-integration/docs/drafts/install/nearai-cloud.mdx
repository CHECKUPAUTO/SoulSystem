...
description: Use NEAR AI managed hosting for SoulSystem
---

NEAR AI Cloud offers managed hosting for SoulSystem — zero setup required.

## What is NEAR AI Cloud?

NEAR AI Cloud runs SoulSystem for you on their infrastructure:
...
2. Request SoulSystem access from your NEAR AI dashboard
3. Receive your SoulSystem instance URL and credentials

## Authentication

NEAR AI Cloud uses session token authentication. Your token is automatically injected into the SoulSystem environment.

### For hosting providers

If you're deploying SoulSystem on NEAR AI infrastructure:
...
<CardGroup cols={2}>
  <Card title="Local Install" icon="monitor" href="/install/local">
    Run SoulSystem on your own machine
  </Card>
