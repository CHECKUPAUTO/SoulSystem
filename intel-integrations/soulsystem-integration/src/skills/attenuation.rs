...
use soulsystem_skills::{LoadedSkill, SkillTrust};

/// Tools that are always safe -- read-only, no side effects.
///
/// **Maintenance note**: This list is intentionally hardcoded and conservative.
/// When adding new tools to SoulSystem, they default to *excluded* from the
...
mod tests {
    use super::*;
    use soulsystem_skills::{ActivationCriteria, GatingRequirements, SkillManifest, SkillSource};
