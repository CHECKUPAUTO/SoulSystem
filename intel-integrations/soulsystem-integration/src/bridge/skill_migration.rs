...
use soulsystem_engine::traits::store::Store;
use soulsystem_engine::types::error::EngineError;
use soulsystem_engine::types::memory::{DocType, MemoryDoc};
use soulsystem_engine::types::project::ProjectId;
use soulsystem_engine::types::shared_owner_id;

use soulsystem_skills::SkillRegistry;
use soulsystem_skills::types::{LoadedSkill, SkillSource};
use soulsystem_skills::v2::{SkillMetrics, V2SkillMetadata, V2SkillSource};
...
mod tests {
    use super::*;
    use soulsystem_skills::types::{ActivationCriteria, SkillManifest, SkillTrust};
    ...
    fn make_v1_skill(name: &str, content: &str) -> LoadedSkill {
        LoadedSkill {
            manifest: SkillManifest {
                ...
                credentials: vec![],
                requires: soulsystem_skills::GatingRequirements::default(),
            },
            ...
            content_hash: soulsystem_skills::compute_hash(content),
