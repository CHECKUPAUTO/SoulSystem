...
use soulsystem_engine::{MountError, ProjectId, WorkspaceMounts};
                    ...
                    let entry_strings: Vec<String> = entries
                        ...
                        .map(|e| {
                            let suffix = match e.kind {
                                soulsystem_engine::workspace::EntryKind::Directory => "/",
                                _ => "",
                            };
...
mod tests {
    ...
    use soulsystem_engine::workspace::{DirEntry, EntryKind, FilesystemBackend, ShellOutput};
    use soulsystem_engine::{MountBackend, ProjectMountFactory, ProjectMounts};
