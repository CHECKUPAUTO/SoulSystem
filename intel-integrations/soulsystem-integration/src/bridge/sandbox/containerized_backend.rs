...
//!
//! Path semantics are identical to [`soulsystem_engine::workspace::FilesystemBackend`]:
...
use soulsystem_engine::workspace::{DirEntry, EntryKind, ShellOutput};
use soulsystem_engine::{MountBackend, MountError};
...
/// consistently with the [`soulsystem_engine::workspace::FilesystemBackend`] equivalents.
