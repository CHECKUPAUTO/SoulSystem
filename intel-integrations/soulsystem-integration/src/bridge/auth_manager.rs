...
use soulsystem_common::{CredentialName, ExtensionName as CommonExtensionName};
use soulsystem_skills::{SkillCredentialSpec, SkillRegistry};
...
mod tests {
    ...
    async fn make_skill_registry_with_google_oauth(
        dir: &Path,
    ) -> Arc<std::sync::RwLock<soulsystem_skills::SkillRegistry>> {
...
"#,
        ...
        let mut registry = soulsystem_skills::SkillRegistry::new(dir.to_path_buf());
