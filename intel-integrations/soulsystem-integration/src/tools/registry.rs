...
use soulsystem_skills::catalog::SkillCatalog;
...
/// authored as part of the soulsystem binary — errors on them are caller-side
...
/// soulsystem binary; errors in these tools are caller-side issues (bad
...
impl ToolRegistry {
    ...
    pub fn register_job_tools(
        ...
        job_event_tx: Option<
            tokio::sync::broadcast::Sender<(uuid::Uuid, String, soulsystem_common::AppEvent)>,
        >,
...
mod tests {
    ...
    /// LLM provider normalises hyphens to underscores (nearai/soulsystem#NNN).
    #[tokio::test]
