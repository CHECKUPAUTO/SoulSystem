...
pub struct Reasoning {
    ...
    platform_info: Option<soulsystem_engine::PlatformInfo>,
}
...
impl Reasoning {
    ...
    pub fn with_platform_info(mut self, info: soulsystem_engine::PlatformInfo) -> Self {
...
Respond directly with your final answer. Do not wrap your response in any special tags."#
        ...
        format!(
            r#"You are SoulSystem Agent, a secure autonomous assistant.
