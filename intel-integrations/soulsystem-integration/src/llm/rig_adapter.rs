//! Generic adapter that bridges rig-core's `CompletionModel` trait to SoulSystem's `LlmProvider`.
//!
...
/// Convert SoulSystem messages to rig-core format.
///
...
/// Convert SoulSystem tool definitions to rig-core format.
///
...
/// Convert SoulSystem tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to SoulSystem types
            _ => {}
        }
    }
