...
/// Convert SoulSystem `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from SoulSystem tool definitions.
...
/// Map Bedrock `StopReason` to SoulSystem `FinishReason`.
