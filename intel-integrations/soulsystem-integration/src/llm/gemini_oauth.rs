...
const GOOG_API_CLIENT: &str = concat!("gl-rust/1.0.0 soulsystem/", env!("CARGO_PKG_VERSION"));
...
impl GeminiOauthProvider {
    ...
    fn to_gemini_request(
        ...
        // sets it because it displays thoughts to the user. SoulSystem's reasoning
