...
/// JSON-file persistence for pending gates under `~/.soulsystem/`.
#[derive(Debug, Clone)]
...
impl FileGatePersistence {
    ...
    pub fn default_path() -> PathBuf {
        soulsystem_base_dir().join("pending-gates.json")
    }
...
mod tests {
    ...
    use soulsystem_engine::{ConversationId, ResumeKind, ThreadId};
