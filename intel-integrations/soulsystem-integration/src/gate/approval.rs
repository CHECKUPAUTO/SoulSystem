...
use soulsystem_engine::gate::{ExecutionGate, ExecutionMode, GateContext, GateDecision, ResumeKind};
...
mod tests {
    use super::*;
    use soulsystem_engine::gate::ExecutionMode;
    use soulsystem_engine::types::capability::{ActionDef, EffectType};
    use soulsystem_engine::types::thread::ThreadId;
