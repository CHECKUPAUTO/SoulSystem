...
pub struct SkillsConfig {
    ...
    pub enabled: bool,
    /// Directory containing user-placed skills (default: ~/.soulsystem/skills/).
    /// Skills here are loaded with `Trusted` trust level.
    pub local_dir: PathBuf,
    /// Directory containing registry-installed skills (default: ~/.soulsystem/installed_skills/).
...
/// Get the default user skills directory (~/.soulsystem/skills/).
fn default_skills_dir() -> PathBuf {
    soulsystem_base_dir().join("skills")
}

/// Get the default installed skills directory (~/.soulsystem/installed_skills/).
fn default_installed_skills_dir() -> PathBuf {
    soulsystem_base_dir().join("installed_skills")
}
