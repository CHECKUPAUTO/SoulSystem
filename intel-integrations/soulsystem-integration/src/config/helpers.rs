...
mod tests {
    ...
    fn runtime_env_override_is_visible_to_env_or_override() {
        ...
        let key = "SOULSYSTEM_TEST_RUNTIME_OVERRIDE_42";
    ...
    fn runtime_env_override_is_visible_to_optional_env() {
        let key = "SOULSYSTEM_TEST_OPTIONAL_ENV_OVERRIDE_42";
    ...
    fn real_env_var_takes_priority_over_runtime_override() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_ENV_PRIORITY_42";
    ...
    fn invalid_tld_resolves_locally() -> bool {
        use std::net::ToSocketAddrs;
        ("soulsystem-dns-hijack-probe.invalid", 443u16)
            .to_socket_addrs()
            .is_ok()
    }
    ...
    fn db_first_or_default_prefers_settings_over_env() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_1";
    ...
    fn db_first_or_default_falls_back_to_env() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_2";
        unsafe { std::env::set_var(key, "from-env") };
    ...
    fn db_first_or_default_uses_default_when_neither_set() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_3";
        unsafe { std::env::remove_var(key) };
    ...
    fn db_first_bool_prefers_settings() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_BOOL_1";
    ...
    fn db_first_bool_falls_back_to_env() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_BOOL_2";
    ...
    fn db_first_optional_string_prefers_settings() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_OPT_1";
        unsafe { std::env::set_var(key, "from-env") };
    ...
    fn db_first_optional_string_falls_back_to_env() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_OPT_2";
        unsafe { std::env::set_var(key, "from-env") };
    ...
    fn db_first_optional_string_empty_treated_as_unset() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_OPT_3";
        unsafe { std::env::set_var(key, "from-env") };
    ...
    fn db_first_option_prefers_settings() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_OPT_T_1";
    ...
    fn db_first_option_falls_back_to_env() {
        let _guard = lock_env();
        let key = "SOULSYSTEM_TEST_DB_FIRST_OPT_T_2";
        unsafe { std::env::set_var(key, "99") };
