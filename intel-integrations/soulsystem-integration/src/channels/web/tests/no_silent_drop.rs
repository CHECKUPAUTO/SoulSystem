...
async fn mission_notification_cross_user_does_not_leak_owner_thread_id() {
    ...
    let notif = soulsystem_engine::MissionNotification {
        mission_id: soulsystem_engine::MissionId(uuid::Uuid::new_v4()),
        mission_name: "test-mission".to_string(),
        thread_id: soulsystem_engine::ThreadId(uuid::Uuid::new_v4()),
