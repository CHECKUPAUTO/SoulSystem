...
pub struct ResponsesRequest {
    ...
    /// SoulSystem extension: structured context injected into the agent's conversation.
    ///
    /// NOT part of the OpenAI Responses API spec — SoulSystem extension.
...
mod tests {
    ...
    fn accumulator_gate_required_marks_failed() {
        ...
        assert!(acc.process(AppEvent::GateRequired {
            ...
            extension_name: Some(soulsystem_common::ExtensionName::new("notion").unwrap()),
