//! Web gateway channel for browser-based access to SoulSystem.
//!
...
// Backward-compat re-exports for the soulsystem#2599 migration. The auth,
    ...
    async fn send_status(
        ...
        let event = match status {
            ...
            StatusUpdate::AuthRequired {
                ...
                extension_name,
                state: soulsystem_common::OnboardingStateDto::AuthRequired,
                request_id,
                message: None,
                instructions,
                auth_url,
