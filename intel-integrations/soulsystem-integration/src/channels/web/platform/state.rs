...
//! exist only for backward compatibility during the soulsystem#2599 migration
...
pub struct GatewayState {
    ...
    pub skill_registry: Option<Arc<std::sync::RwLock<soulsystem_skills::SkillRegistry>>>,
