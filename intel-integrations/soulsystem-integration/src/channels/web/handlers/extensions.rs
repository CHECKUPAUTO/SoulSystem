...
///
/// See nearai/soulsystem#1921 for the regression that motivated plumbing
...
mod tests {
    ...
    /// regression that drops one axis (the bug shape behind nearai/soulsystem#1921)
    ...
    fn paired_wasm_channel_without_owner_binding_is_active() {
        ...
        assert_eq!(
            ...
            "a WASM channel with paired senders must report Active even when \
             no owner binding is set (nearai/soulsystem#1921)"
        );
    }
