//! agent data migration and import functionality.
//!
//! Provides tools to migrate existing agent installations (memory, history,
//! settings, and credentials) into SoulSystem without data loss.
...
/// Configuration options for Agent import.
#[derive(Debug, Clone)]
pub struct ImportOptions {
    /// Path to the Agent directory (default: ~/.agent).
...
pub enum ImportError {
    #[error("Agent not found at {path}: {reason}")]
