//! Agent conversation history import.
...
use super::reader::AgentConversation;
...
///
/// **Note on Idempotency**: The metadata includes `agent_conversation_id` for deduplication
...
pub async fn import_conversation_atomic(
    ...
    // On reimport, the agent_conversation_id metadata will detect it.
...
mod tests {
    use super::*;
    use crate::import::legacy_agent::reader::AgentImportMessage;

    #[test]
    fn test_conversation_import_structure() {
        // Verify that AgentConversation can be created with test data
