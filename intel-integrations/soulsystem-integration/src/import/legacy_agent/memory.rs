...
use super::reader::AgentMemoryChunk;

/// Import a single memory chunk into SoulSystem.
...
mod tests {
    ...
    fn test_memory_chunk_import_structure() {
        // Verify that AgentMemoryChunk can be created with test data
        let chunk = AgentMemoryChunk {
