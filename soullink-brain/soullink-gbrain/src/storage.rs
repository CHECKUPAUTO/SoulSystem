...
impl Database {
    ...
    pub fn init(&self) -> Result<()> {
        ...
        // Index for faster reverse edge lookups
        conn.execute(
    ...
    /// Optimized lookup for a single entity by ID.
    ...
    /// Optimized count for edges related to an entity.
    pub fn get_edge_count_for_entity(&self, entity_id: &str) -> Result<usize> {
        let conn = self.conn.lock().unwrap();
