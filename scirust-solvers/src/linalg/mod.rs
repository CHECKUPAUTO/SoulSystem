...
pub use eigen::{eigen_symmetric, EigenSymmetric};
pub use eigen_general::{eigenvalues_general, Eigenvalue};
pub use gmres::{gmres, gmres_preconditioned};
pub use iterative::conjugate_gradient;
pub use lu::{lu_decompose, solve, solve_lu, Lu};
pub use precond::{identity_precond, JacobiPreconditioner};
pub use qr::{qr_decompose, solve_qr_least_squares, Qr};
